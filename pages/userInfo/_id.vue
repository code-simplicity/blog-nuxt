  ...
  <div class="user-detail-info-box  clear-fix ">
    ...
    <div class="user-info-right-part float-left" id="user-info-right-part">
      <el-form label-width="86px" v-if="userInfo !== null" size="medium">
        ...
        <div class="info-item">
          <span class="info-left clear-fix"
            >邮箱：
        ...
        <div class="update-btn" v-if="isEditorMode">
          <el-button size="medium" type="primary" @click="updateUserInfo"
            >更新</el-button
          >
        </div>
        <div class="user-info-editor-btn" v-if="parUserId === currentUserId">
          <el-button
            size="medium"
            :type="isEditorMode ? 'danger' : 'primary'"
            @click="switchEditorMode"
            v-text="!isEditorMode ? '编辑' : '取消'"
          ></el-button>
        </div>
      </el-form>
    </div>
