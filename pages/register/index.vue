    ...
    <div class="register-form-container">
      ...
      <div class="form-content">
        <el-form label-width="100px">
          <el-form-item
            label="用户名" required>
            <el-input v-model="sobUser.userName" @blur="checkUserName" placeholder="请输入用户名"></el-input>
            <span class="el-icon-error" v-if="isUserNameOkay==='1'"> 该用户已注册</span>
            <span class="el-icon-success" v-if="isUserNameOkay==='0'"> 您的用户名也太棒了</span>
          </el-form-item>
          <el-form-item
            label="密  码" required>
            <el-input v-model="originalPassword" type="password" placeholder="请输入密码"></el-input>
          </el-form-item>
