  ...
  <div id="blog-box">
    ...
    <div class="logo-box float-left">
      ...
      <div id="login-tips-text-box" style="display: none;" class="login-tips-text-box float-right" >
        <span>
          <a :href="'/login'+redirectPath"><i class="sob_blog sobfingermap"></i> 登陆</a>
        </span>
        <span>
...
<!--      </NuxtLink>-->
      <NuxtLink to="/message">
        <span :class="$store.state.currentActivityTab ==='message'?'header-title-activity':''"><i
          class="el-icon-chat-dot-round"></i> 留言</span>
      </NuxtLink>
      <NuxtLink to="/about">
        <span :class="$store.state.currentActivityTab ==='about'?'header-title-activity':''"><i
          class="sob_blog sobabout_line"></i> 关于</span>
      </NuxtLink>
      <NuxtLink to="/link">
    ...
    <div class="blog-footer">
      <div class="copy-right-box">
        <p>
          Copyright ©
          <a href="https://www.bugdr.cn/" target="_blank">
            本是人间红尘客
          </a>
      ...
      <div>
        <div class="keep-on-record clear-fix">
          <div class="float-left">
            <a href="http://beian.miit.gov.cn/" target="_blank">黔ICP备2021002417号-1</a>
          </div>
    ...
    methods:{
      ...
      handlerCommand(command) {
        if (command === 'logout') {
          ...
          location.href = 'https://mp.bugdr.cn/#/index'
